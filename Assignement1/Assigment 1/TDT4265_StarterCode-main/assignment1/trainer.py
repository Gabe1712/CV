...
class BaseTrainer:
    ...
    def train(
        ...
        #Enable or disable 
        early_stop_enable =True #Turns possible to turn on and off the use of the ealy stopping
        global_step = 0
        ...
        for epoch in range(num_epochs):
            ...
            for X_batch, Y_batch in iter(train_loader):
                ...
                if global_step % num_steps_per_val == 0:
                    ...
                    #We increment 0.0015 to add patience to our early stopping 
                    if early_stop_enable:
                        loss_values_List =list(val_history["loss"].values())
                        if min(loss_values_List) + 0.0015 < min(loss_values_List[-10:]):
                            print("stopped at epoch" + str(epoch) + "of"+ str(num_epochs))
